const siteData = {
  ...
  schoolNameEn: "Nihon University Narashino High School",
  shortName: "日大習志野",
  theme: {
    brand: "#0f2a5c",
    accent: "#d7263d",
  ...
  hero: {
    label: "日本大学理工学部 船橋キャンパスの中にある高校",
    lines: ["自ら学ぶ。", "自ら考える。", "自ら道をひらく。"],
    lead: "日本大学のスクールミッション「自主創造」を、理工学部 船橋キャンパスの中で。1929年創立、通称「日習」。ここで過ごす3年間が、確かな未来へつながっていく。",
    note: "東葉高速線 船橋日大前駅 西口から徒歩5分",
    artCaption: "2011年竣工の校舎と、2015年に架かった体育館への専用陸橋。"
  },
  song: {
    label: "校歌",
    title: "鳥のように 草のように 詩のように"
  },
  ticker: [
    "自主創造",
    "船橋日大前駅から徒歩5分",
  ...
  stats: [
    { value: "5", unit: "分", label: "船橋日大前駅 西口から徒歩" },
    { value: "32", unit: "部", label: "運動部16・文化部16" },
    { value: "3", unit: "コース", label: "2年次からNP・GA・CSTへ" },
    { value: "1929", unit: "年", label: "創立。2029年に100周年" }
  ],
  featuresTitle: "日習の魅力は、大学のキャンパスの中から始まる。",
  featuresSub: "ここに書いてあるのは、公式サイトから分かること。本当の日習は、生徒のみなさんに教えてもらいます。",
  features: [
    {
      tag: "立地",
      title: "大学のキャンパスが、通学路。",
      body: "校舎は日本大学理工学部 船橋キャンパスの中。船橋日大前駅の西口から歩いて5分、大学生と同じ緑の中を通って登校します。3階の小ラウンジからはキャンパスが一望できます。"
    },
    {
      tag: "施設",
      title: "人工芝のグラウンドと、照明付きのコート",
      body: "2014年に全面人工芝になったグラウンド、照明付きのオムニコート3面、タータンの練習走路。体育も部活動も、思いきり。"
    },
    {
      tag: "高大連携",
      title: "高校にいながら、大学の授業",
      body: "3年生は科目履修生として理工学部の授業を聴講でき、試験に合格すれば入学後の単位になります。"
    }
  ],
  mission: {
    word: "自主創造",
    reading: "JISHU SOZO",
    phrases: ["自ら学ぶ", "自ら考える", "自ら道をひらく"],
    caption: "日本大学の教育理念であり、日習のスクールミッション。自主創造の精神、高い理想と真剣な学習態度、知育・徳育・体育の調和を、3つの教育目標として掲げています。",
    powersLabel: "育成を目指す 10の力",
    powers: ["知力・学力", "課題対応力", "論理的思考力", "原因分析力", "傾聴力", "受信・発信力", "協働力", "行動力", "自己管理能力", "自己実現力"]
  },
  learning: {
    title: "1年生は同じスタートライン。2年生から、3つのコースへ。",
    body: "1年次は平均化クラスで基礎を固め、2年次からNP・GA・CSTに分かれます。1人1台のタブレットを使う授業、オーストラリア語学研修、ケンブリッジのプログラムなど、選べる学びが用意されています。",
    courses: [
      { code: "NP", name: "国公立進学コース", body: "国公立大学などへの進学を目指すコース。文系・理系の両方に置かれています。" },
      { code: "GA", name: "総合進学コース", body: "日本大学をはじめ、幅広い進路に対応するコース。文系・理系の両方に置かれています。" },
      { code: "CST", name: "理工学部進学コース", body: "日本大学理工学部への進学を目指す理系コース。理工学部の授業を高校のうちから受け、単位を先取りできます。" }
    ],
    openLabel: "理工学部の開放科目（一部）",
    openSubjects: ["基礎物理学実験", "基礎化学実験", "技術者倫理", "知的財産権論", "科学技術と経済", "心理学", "法学", "哲学"]
  },
  voicesTitle: "日習の学びと生活、生徒の声。",
  voicesSub: "AIは公式サイトの情報しか知りません。この3つの枠は、今日のみなさんの言葉で埋めます。",
  voices: [
    { placeholder: true, name: "1年生", role: "募集中", quote: "日習のいいところ、教えてください。ここに君たちの言葉が入ります。" },
    { placeholder: true, name: "1年生", role: "募集中", quote: "好きな場所、好きな時間、自慢したいこと。なんでもOKです。" },
    { placeholder: true, name: "1年生", role: "募集中", quote: "本当の日習は、君たちしか知りません。" }
  ],
  eventsTitle: "一年を動かす行事。",
  eventsSub: "公式の年間行事から、1年生に関係の深いものを並べました。",
  events: [
    { month: "04", title: "入学式・新入生研修会", body: "新しい仲間と、日習の3年間が始まる。" },
    { month: "05", title: "体育祭", body: "クラスの団結が試される、春の大イベント。" },
    { month: "07", title: "理工学部長講演", body: "1年生全員が、隣の理工学部の学部長の話を聞く。" },
    { month: "09", title: "校外研修II 日本大学学部見学会", body: "1年生が日本大学の学部を訪ねる。この模擬講義も、この行事の一部。", highlight: true, badge: "TODAY 9.8" },
    { month: "11", title: "文化祭", body: "クラス展示や文化部の発表で、学校中がいちばん華やぐ日。" },
    { month: "02", title: "修学旅行", body: "2年生の一大イベント。学年みんなで出かける。" },
    { month: "03", title: "卒業式", body: "3年間の締めくくり。" }
  ],
  clubsTitle: "32の部活動。",
  clubsSub: "運動部16、文化部16。公式サイトの一覧から。",
  clubs: [
    { name: "運動部", note: "SPORTS", items: ["野球", "陸上", "サッカー", "ラグビー", "ソフトテニス", "テニス", "フェンシング", "バスケットボール", "バレーボール", "卓球", "バドミントン", "剣道", "ソフトボール", "チアリーダー", "水泳（同好会）"] },
    { name: "文化部", note: "CULTURE", items: ["物理", "化学", "生物", "美術", "写真", "演劇", "放送", "英語", "吹奏楽", "茶道", "華道", "書道", "社会", "文芸（同好会）", "ICT研究（同好会）", "生徒会運営委員会"] }
  ],
  campusTitle: "キャンパスと、通学路。",
  campusSub: "校舎は理工学部 船橋キャンパスの中。今日の模擬講義がある14号館も、すぐ隣です。",
  facilities: [
    { name: "生徒ラウンジ", body: "売店でお弁当や文房具が買える多目的スペース" },
    { name: "小ラウンジ（3階）", body: "理工学部 船橋キャンパスを一望できる" },
    { name: "図書室", body: "閲覧室と自習室。机には有線LAN端子" },
    { name: "COMMON SPACE", body: "3・4階。休み時間や放課後に使える" },
    { name: "コンピュータ教室", body: "最新型48台" },
    { name: "人工芝グラウンド", body: "2014年に全面人工芝化" },
    { name: "テニスコート", body: "照明付きの人工芝オムニコート3面" },
    { name: "専用陸橋", body: "2015年竣工。校舎と体育館をつなぐ" }
  ],
  access: [
    { mode: "東葉高速線", body: "船橋日大前駅 西口から徒歩5分" },
...
setText("[data-school-name]", siteData.schoolName);
setText("[data-school-name-short]", siteData.shortName);
setText("[data-school-name-short-footer]", siteData.shortName);
setText("[data-hero-label]", `${siteData.hero.label}　/　${siteData.schoolNameEn}`);
setText("[data-hero-lead]", siteData.hero.lead);
setText("[data-hero-note]", siteData.hero.note);
setText("[data-hero-art-caption]", siteData.hero.artCaption);
setText("[data-song-label]", siteData.song.label);
setText("[data-song-title]", siteData.song.title);
setText("[data-features-title]", siteData.featuresTitle);
setText("[data-features-sub]", siteData.featuresSub);
setText("[data-mission-reading]", siteData.mission.reading);
setText("[data-mission-word]", siteData.mission.word);
setText("[data-mission-caption]", siteData.mission.caption);
setText("[data-powers-label]", siteData.mission.powersLabel);
setText("[data-learning-title]", siteData.learning.title);
setText("[data-learning-body]", siteData.learning.body);
...
setText("[data-clubs-sub]", siteData.clubsSub);
setText("[data-campus-title]", siteData.campusTitle);
...
function renderHeroTitle() {
  const html = siteData.hero.lines
    .map((line, index) => {
      const match = line.match(/^(.*?)([。！？!?]*)$/);
      const text = escapeHtml(match ? match[1] : line);
      const punct = match && match[2] ? `<span class="punct">${escapeHtml(match[2])}</span>` : "";
      return `<span class="line"><span style="--d:${(0.15 + index * 0.14).toFixed(2)}s">${text}${punct}</span></span>`;
    })
    .join("");
...
function renderHeroArt() {
  ...
  const el = (tag, attrs) => {
    const attributes = Object.entries(attrs)
      ...
      .join(" ");
    const delay = (0.2 + order * 0.035).toFixed(2);
    order += 1;
    parts.push(`<${tag} class="d" pathLength="1" style="--d:${delay}s" ${attributes}/>`);
  };

  el("line", { x1: 16, y1: 300, x2: 624, y2: 300 });
  el("path", { d: "M16 322 Q320 306 624 322", "stroke-opacity": 0.5 });

  el("rect", { x: 56, y: 96, width: 84, height: 204 });
  el("rect", { x: 72, y: 116, width: 52, height: 160 });
  for (let y = 156; y < 276; y += 40) el("line", { x1: 72, y1: y, x2: 124, y2: y });

  el("rect", { x: 140, y: 128, width: 224, height: 172 });
  el("line", { x1: 136, y1: 128, x2: 368, y2: 128 });
  for (let y = 171; y < 300; y += 43) el("line", { x1: 140, y1: y, x2: 364, y2: y });
  for (let row = 0; row < 4; row += 1) {
    for (let column = 0; column < 7; column += 1) {
      el("rect", { x: 154 + column * 30, y: 140 + row * 43, width: 18, height: 22 });
    }
  }

  el("line", { x1: 350, y1: 128, x2: 350, y2: 94 });
  el("path", { d: "M350 94 L374 100 L350 106 Z", stroke: "var(--accent)" });

  el("path", { d: "M364 200 L444 210" });
  el("path", { d: "M364 214 L444 224" });
  for (let x = 382; x <= 430; x += 16) {
    el("line", { x1: x, y1: 214 + (x - 364) * 0.125, x2: x, y2: 300 });
  }

  el("path", { d: "M444 300 V178 Q520 132 596 178 V300" });
  el("line", { x1: 444, y1: 178, x2: 596, y2: 178 });
  el("rect", { x: 470, y: 236, width: 100, height: 64 });

  [
    [34, 262, 20],
    [614, 268, 16]
  ].forEach(([x, y, r]) => {
    el("line", { x1: x, y1: 300, x2: x, y2: y + r });
    el("circle", { cx: x, cy: y, r });
  });

  setHtml(
    "[data-hero-art]",
    `<svg viewBox="0 0 640 340" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${parts.join("")}</svg>`
  );
}

function renderTicker() {
  const items = siteData.ticker.map((item) => `<span class="ticker-item">${escapeHtml(item)}</span>`).join("");
  setHtml("[data-ticker]", `<div class="ticker-track">${items}${items}</div>`);
}
  ...
  setHtml(
    ...
    siteData.stats
      .map(
        (stat) => `
          <div class="num">
            <div class="num-value">${escapeHtml(stat.value)}<small>${escapeHtml(stat.unit || "")}</small></div>
            <p class="num-label">${escapeHtml(stat.label)}</p>
          </div>
        `
      )
      .join("")
      ...
      .map(
        (feature, index) => `
          <article class="tile">
            ...
            <span class="tile-tag">${escapeHtml(feature.tag || "")}</span>
...
function renderMission() {
  setHtml(
    "[data-mission-phrases]",
    siteData.mission.phrases
      .map(
        (phrase, index) => `
          <div class="phrase">
  ...
  setHtml("[data-powers]", siteData.mission.powers.map((power) => `<li>${escapeHtml(power)}</li>`).join(""));
}

function renderLearning() {
  setHtml(
    "[data-courses]",
    siteData.learning.courses
      .map(
        (course) => `
  ...
  setHtml("[data-open-subjects]", siteData.learning.openSubjects.map((subject) => `<li>${escapeHtml(subject)}</li>`).join(""));
}
...
function renderVoices() {
  setHtml(
    ...
    siteData.voices
      .map(
        (voice) => `
          <article class="voice${voice.placeholder ? " is-placeholder" : ""}">
            <p class="voice-quote">${escapeHtml(voice.quote)}</p>
            <p class="voice-meta"><b>${escapeHtml(voice.role)}</b>　${escapeHtml(voice.name)}</p>
          </article>
        `
      )
      .join("")
...
function renderEvents() {
  setHtml(
    ...
    siteData.events
      .map(
        (event) => `
          <article class="event${event.highlight ? " is-highlight" : ""}">
            <div class="event-month">${escapeHtml(event.month)}<small>月</small></div>
      ...
      .map(
        (group) => `
          <div class="club-group">
            <h3>${escapeHtml(group.name)}<small>${escapeHtml(group.note || "")}</small></h3>
            <ul class="chips">${group.items.map((item) => `<li>${escapeHtml(item)}</li>`).join("")}</ul>
          </div>
        `
      )
      .join("")
...
function renderCampus() {
  setHtml(
    "[data-facilities]",
    siteData.facilities
      .map((facility) => `<li><strong>${escapeHtml(facility.name)}</strong><span>${escapeHtml(facility.body)}</span></li>`)
      .join("")
  );
  setHtml(
    "[data-access]",
    siteData.access.map((route) => `<li><b>${escapeHtml(route.mode)}</b><span>${escapeHtml(route.body)}</span></li>`).join("")
  );
  setHtml("[data-route-map]", routeMapSvg());
}
...
function routeMapSvg() {
  ...
  return `
    <svg viewBox="0 0 640 260" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="${t(map.start)}から${t(map.goal)}までの略図">
      ...
      <rect x="278" y="192" width="58" height="28" rx="3" stroke-opacity="0.4"/>
